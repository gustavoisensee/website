...
export default function Career() {
  return (
    <div>
      ...
      <p className="text-base leading-relaxed">{locale.pages.career.description_1}</p>
      <p className="text-base leading-relaxed pb-8">{locale.pages.career.description_2}</p>

      <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
        {locale.pages.career.jobs.map(({ period, company, companyImg, title, description }, i) => (
          <li key={i}>
            {i > 0 && <hr />}

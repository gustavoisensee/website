...
function LangPage () {
	...
	var _ptBR = {
		...
		myDescription: "Olá, Eu trabalho com desenvolvimento web a " + workedYears + " anos, sou formado em Sistemas de Informação pela UNISUL e também em técnico de programação pelo colégio SENAI. Trabalhei em duas empresas privadas, participo de projetos open source no GitHub, sou um grande entusiasta Javascript e atualmente estou trabalhando no LabTrans, Laboratório de Transportes e Logística da Universidade Federal de Santa Catarina, Brasil.",
		...
		_enUS = {
			...
			myDescription: "Hi, I work with web development for " + workedYears + " years, I'm graduated in Information Systems at Unisul and also in technical programming at SENAI college. I have worked in two private companies and also participate in open source projects on Github. I'm a great Javascript enthusiast and I'm currently working at Labtrans, Transport and Logistics Laboratory of the Federal University of Santa Catarina, Brazil.",
